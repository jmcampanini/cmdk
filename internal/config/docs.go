	...
	return []SectionDoc{
		...
		},
		{
			...
			Fields: []FieldDoc{
				...
				{Name: "allow_empty", Type: "bool", Description: "Allow empty input for prompt stages. When false (default), pressing Enter on an empty prompt shows an error. Only for type = \"prompt\".", Validation: "forbidden for picker"},
			},
